...
# Prompt Gemini
SUM_PROMPT_TEMPLATE = (
    "Tugas kamu adalah merangkum isi bab dari sebuah dokumen ilmiah (skripsi/ta/tesis) "
    "dengan fokus pada inti informasi. Hasil ringkasan harus memenuhi aturan berikut:\n"
    "1. TULIS dalam bentuk paragraf (bukan bullet/nomor).\n"
    "2. JANGAN menyalin ulang kalimat asli dari teks, lakukan parafrase.\n"
    "3. Ambil hanya inti informasi, jangan bertele-tele.\n"
    "4. Jangan sertakan kutipan, tabel, gambar, atau daftar tidak penting.\n"
    "5. Jika ini BAB 1, jelaskan: latar belakang, masalah, tujuan.\n"
    "6. Jika BAB 2, jelaskan: teori inti + peneliti terdahulu singkat.\n"
    "7. Jika BAB 3, jelaskan: metode, data, variabel, teknik analisis.\n"
    "8. Jika BAB 4, jelaskan: hasil utama + temuan penting.\n"
    "9. Jika BAB 5, jelaskan: kesimpulan + saran singkat.\n"
    "10. Ringkasan harus runtut, jelas, dan akademik.\n\n"
    "HASIL OUTPUT:\n"
    "- Kembangkan ringkasan dalam 1–3 paragraf.\n"
    "- Jangan mulai dengan pengulangan judul.\n"
    "- Jangan tiba-tiba berhenti di tengah kalimat.\n\n"
    "TEKS ASLI:\n\"\"\"{content}\"\"\"\n\n"
    "RINGKASAN:\n"
)
